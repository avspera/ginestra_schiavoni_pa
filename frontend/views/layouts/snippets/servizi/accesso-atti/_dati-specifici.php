                            ...
                            <div class="card-body">
                                <div class="form-check m-0">
                                    <div class="radio-body border-bottom border-light">
                                        <input <?= $model->type == 1 ? "checked" : "" ?> onclick="checkPayment(1)" value="1" name="AccessoAtti[type]" type="radio" id="accessoatti-type-1" required="">
                                        <label for="accessoatti-type-1">Standard</label>
                                    </div>
                                </div>
                                <div class="form-check m-0">
                                    <div class="radio-body border-bottom border-light">
                                        <input <?= $model->type == 2 ? "checked" : "" ?> onclick="checkPayment(2)" value="2" name="AccessoAtti[type]" type="radio" id="accessoatti-type-2" required="">
            ...
            <div class="card has-bkg-grey shadow-sm p-4 pt-lg-30 pb-lg-30 pl-lg-30 pr-lg-30">
                ...
                <div class="card-body p-0">
                    <div class="bg-white p-3 p-lg-4">
                        <div class="form-check m-0">
                            <div class="radio-body border-bottom border-light">
                                <input <?= $model->type == 1 ? "checked" : "disabled" ?> value="1" name="AccessoAtti[payment]" type="radio" id="accessoatti-payment-1" required="">
                                <label class="disabled" for="accessoatti-payment-1">Nessuno</label>
                            </div>
                            <div class="radio-body border-bottom border-light">
                                <input <?= $model->type == 2  ? "checked" : "disabled" ?> value="2" aria-labelledby="accessoatti-payment-2-help" name="AccessoAtti[type]" type="radio" id="accessoatti-payment-2" required="">
                                <label class="disabled" for="accessoatti-payment-2">150 € </label>
                ...
                <div class="card-body p-0">
                    <div class="bg-white p-3 p-lg-4">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="AccessoAtti[messaggio_richiesta]" id="accessoatti-messaggio_richiesta" rows="3"><?= $model->messaggio_richiesta ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
