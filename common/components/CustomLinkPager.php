 ...
 * @copyright DevHopes - Spera 21/12/2023
...
class CustomLinkPager extends LinkPager
{
    ...
    protected function renderPageButtons()
    {
        ...
        $buttons    = Html::tag($tag, implode("\n", $buttons), $options);
        $container  = Html::tag("nav", $buttons, ["class" => "pagination-wrapper justify-content-center", "aria-label" => "Pagine"]);
        return $container;
    }
