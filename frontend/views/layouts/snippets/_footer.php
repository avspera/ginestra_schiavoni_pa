        ...
        <div class="container">
            <div class="row">
                <div class="col-12 footer-items-wrapper logo-wrapper">
                    <img class="ue-logo" src="<?= Yii::getAlias("@web") ?>/images/logo-eu-inverted.svg" alt="logo Unione Europea">
                    <div class="it-brand-wrapper">
                        <a href="#">
                            <svg class="icon" aria-hidden="true">
                                <use xlink:href="<?= Yii::getAlias("@web") ?>/bootstrap-italia/svg/sprites.svg#it-pa"></use>
                            </svg>
                            <div class="it-brand-text">
                                <h2 class="no_toc">Ginestra degli Schiavoni</h2>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-9 mt-md-4 footer-items-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p class="footer-info">Comune di Ginestra degli Schiavoni<br>
                                Via Porta Nuova 2 - 82020 Ginestra Degli Schiavoni<br>
                                Codice fiscale / P. IVA: 8000443062/00688690627<br><br>
                                <a href="#">Ufficio Relazioni con il Pubblico</a><br>
                                Numero verde: 800 016 123<br>
                                SMS e WhatsApp: +39 320 1234567<br>
                                Posta Elettronica Certificata: <a style="color:white" href="mailto:uff.amm.vo.moffa.ginestra@asmepec.it">uff.amm.vo.moffa.ginestra@asmepec.it</a><br>
                ...
                <div class="col-md-3 mt-md-4 footer-items-wrapper">
                    ...
                    <ul class="list-inline text-start social">
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="<?= Yii::getAlias("@web") ?>/bootstrap-italia/svg/sprites.svg#it-facebook"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="<?= Yii::getAlias("@web") ?>/bootstrap-italia/svg/sprites.svg#it-whatsapp"></use>
                                </svg>
