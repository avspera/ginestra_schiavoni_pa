...
class AttoDiMatrimonioSearch extends AttoDiMatrimonio
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'coniuge_uno' => $this->coniuge_uno,
            'coniuge_due' => $this->coniuge_due,
