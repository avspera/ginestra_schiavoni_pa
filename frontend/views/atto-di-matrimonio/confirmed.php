...
$this->title = "Richiesta #" . $model->numero_protocollo . " del " . \common\components\Utils::formatDate($model->data_richiesta) . " inviata correttamente";
...
<div class="row justify-content-center">
    <div class="col-12 col-lg-10">
        ...
        <div class="cmp-heading pb-3 pb-lg-4">
            ...
            <p class="subtitle-small">Grazie abbiamo ricevuto la tua richiesta per la pratica <strong><?= $model->numero_protocollo ?></strong> Pubblicazione Atto di Matrimonio</p>
                    ...
                    <div class="cmp-timeline">
                        ...
                        <div class="calendar-vertical mb-3" data-element="service-calendar-list">
                            <div class="calendar-date">
                                <?php
                                $dataEsito = new DateTime($model->data_richiesta);
                                $days = "30";
