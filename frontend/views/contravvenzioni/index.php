            ...
            <div class="card-wrapper card-space">
                <div class="card card-bg ">
                    <div class="card-header">
                        <h3 class="card-title h5 ">Risultato della ricerca</h3>
                    </div>
                    <div class="card-body">
                        <div class="table table-responsive">
                            <?php if (!empty($dataProvider->getModels())) { ?>
                                    ...
                                    'columns' => [
                                        ...
                                        <span>Dettagli</span>
                                                ...
                                                'pay' => function ($url, $model) {
                                                    ...
                                                    $html = '<a href="' . Url::to(["pre-pay", "id" => $model->id]) . '" class="btn btn-xs btn-success btn-xs btn-icon" role="button" aria-disabled="true">
                                        <svg class="icon icon-white">
                                          <use
                                ...
                                ?>
                            <?php } else { ?>
                                <p>Nessuna informazione da mostrare</p>
                            <?php } ?>
                        </div>
                    </div>
                </div>
